...
export default function CardHarga({ status, harga, children,konten }) {
  return (
    <>
      <div className='bg-white shadow-black/5 max-w-sm shadow-xl m-2 px-7 pt-6 hover:scale-105 duration-300'>
        ...
        <button className="py-3 my-8 hover:bg-[#fe7944] font-source-sans font-semibold shadow-lg shadow-[#fe5d4446] bg-[#fe5d44] rounded w-full text-white">Download</button>
      </div>
    </>
  )
}
