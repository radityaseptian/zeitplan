...
export default function Ulasan() {
  return (
    <div className='bg-[#fe5d441e]'>
      <div className='container mx-auto max-w-6xl py-10 lg:py-24'>
        ...
        <div className='grid md:grid-cols-2 lg:grid-cols-3 lg:items-start p-4 md:p-2 lg:p-0 gap-2 sm:gap-3 md:gap-4'>
          ...
          <CardReview name='Wahyu Hayuk' value={1} status='Mahasiswa Abadi'>
          ...
          <CardReview name='Jumadi RT.03' value={1} status='Ketua RT.06'>
